...
Bat researchers rely on access to a vast corpus of bat literature to help advance our understanding of bats and the ecosystems they live in. Some researchers build and organize their personal literature collection using digital tools like Zotero and EndNote, whereas others use homegrown methods to manage their personal research literature collections. To help provide access to bat research literature for all, Plazi (https://plazi.org) and the GBatNet Bat Eco-Interactions Working Group compiled the Bat Literature Corpus (BatLit). BatLit is an actively managed, digital, versioned, and citable collection of bat research literature and their associated metadata. BatLit based on publications  compiled from existing literature corpora contributed by bat researchers. BatLit is designed to be used in manual (e.g., point-and-click) as well as automated workflows (e.g., text mining, language model training), and can be accessed in many ways, including, but not limited to, external storage media, Zenodo and GitHub. As BatLit continues to improve and grow, we aim to continue to democratize access to bat literature, accelerate research and help reduce the barrier to knowledge for bat researchers around the world. This curated corpus will enable automated and programmatic exploration (e.g., text search, machine learning applications such as training of large language models) of the knowledge embedded within. We invite you to contribute your reference library to BatLit and help increase access for all.
